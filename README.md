...
vhsbot is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start vhsbot locally by running:
...
Then you can interact with vhsbot by typing `vhsbot help`.

    vhsbot> vhsbot help
    vhsbot animate me <query> - The same thing as `image me`, except adds [snip]
